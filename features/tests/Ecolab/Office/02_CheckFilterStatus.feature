...
Feature: Check filter status
    ...
    Scenario: 02_Check filter status
       ...
       # And I expect this element "Loader" is not visible
       # And I expects that element "tmsGridCellLeft" contains the text "В подборке"
       # And I click on this element "RemoveFilter"
       #Then I expect this element "Loader" is not visible
      ...
      #Then I expect this element "Loader" is not visible
        ...
        And I click on this element "RemoveFilter"
        Then I expect this element "Loader" is not visible
        #проверка фильтра "Удалена" у колонки "Статус накладной"
        When I click on this element "statusOfDeliveryNote"
        And I click on this element "Удалена"
        And I expect this element "Loader" is not visible
        And I expects that element "tmsGridCellLeft" contains the text "Удалена"
        And I click on this element "RemoveFilter"
        Then I expect this element "Loader" is not visible
