...
Feature: Check old waybills
    ...
    I want to check old waybills goes forward and back
        ...
        # находим накладную
    Scenario Outline:15_Deliver Old Waybills Forward And Black
        Given I log in as a "<login coordinator>" on homepage
        And I expect this element "Loader" is not visible
        And I wait on elements "Office"
        When I click on this element "RemoveFilter"
        And I expect this element "Loader" is not visible
        #установка 2017 года и проверка накладной 671051
        And I expect this element "Loader" is not visible
        And I set date years "2015"
        And I expect this element "Loader" is not visible
        Then I click in standart element "671051"
        And I expect this element "Loader" is not visible
       ...
       # откат с Подтверждена до ТС заказано в перевозке
        ...
        Examples:
            ...
            | Автобал | Ecolab Transport Coordinator |
