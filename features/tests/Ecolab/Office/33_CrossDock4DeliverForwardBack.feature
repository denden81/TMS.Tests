...
Feature: Check 4 Cross Dock waybills
    ...
    I want to check 4 Cross Dock waybills goes forward and back
        ...
        # создаем накладную
    Scenario Outline: 33_4 Cross Dock Waybills Goes Forward And Back
       ...
       # перевести статус "В перевозке"
        ...
        Examples:
            | TK      | shipping warehouse | delivery warehouse   | delivery warehouse 2       | delivery warehouse 3 | delivery warehouse 4       | vendorcode | number vendorcode | login coordinator            |
            | Автобал | 011_M0000000510    | 660459-N_660459-N.00 | М0000000119_М0000000119.00 | TM3_650672-N         | М0000000107_М0000000107.00 | 0193537    | 120               | Ecolab Transport Coordinator |
