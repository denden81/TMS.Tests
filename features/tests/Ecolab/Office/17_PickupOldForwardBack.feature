...
Feature: Check old pickup waybills
    ...
    I want to check old pickup waybills goes forward and back
        ...
        # находим накладную
    Scenario Outline:17_Pickup Old Forward And Back
        Given I log in as a "<login coordinator>" on homepage
        And I expect this element "Loader" is not visible
        And I wait on elements "Office"
        When I click on this element "RemoveFilter"
        And I expect this element "Loader" is not visible
        # установка 2018 года и проверка накладной SНАVP-000593-2019
        And I expect this element "Loader" is not visible
        And I set date years "2018"
        And I expect this element "Loader" is not visible
        Then I click in standart element "SНАVP-000593-2019"
        And I expect this element "Loader" is not visible
