...
Feature: additional expensive TK
    ...
    Scenario Outline: 41_Additional Expensive TK
       ...
       #заходим транспортной компанией и заполняем доп затраты
        ...
        And thes element "Грид перевозки весь" contains the text "64000"

        Examples:
            | TK    | shipping warehouse | delivery warehouse | vendorcode | number vendorcode | login coordinator         | transport company     |
            | ИТЕКО | Склад Истры        | Пенза              | 1102001281 | 7000              | Bac Transport Coordinator | Bac Transport Company |
