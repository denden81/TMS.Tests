...
Feature: Check driver
    ...
    Scenario: 10_Sort Driver
        ...
        And I expect this element "Loader" is not visible
        And I expects that element "footerGridDriver" contains the text "Номер доверенности"
        #сортируем по Экспедитор
        When I click on this element "Колонка Экспедитор"
        And I expect this element "Loader" is not visible
        And I expects that element "footerGridDriver" contains the text "Экспедитор"
        Then I click on this element "Колонка Экспедитор"
        And I expect this element "Loader" is not visible
        And I expects that element "footerGridDriver" contains the text "Экспедитор"
