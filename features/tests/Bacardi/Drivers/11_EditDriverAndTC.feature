...
Feature: Edit Driver And TC
    ...
    Scenario Outline: 11_Edit Driver And TC
       ...
       # проверить что водитель сохранен
        ...
        Examples:
            ...
            | Бакума Петр Алексеевич | водитель изменен на Бакума Петр Алексеевич | К222НН67 | ТС изменено на К222НН67 | ЛТ Групп | Склад Истры        | Пенза              | 1102001281 | 7000              | Bac Transport Coordinator |
