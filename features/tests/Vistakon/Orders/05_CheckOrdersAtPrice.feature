...
Feature: Check order
    ...
    Scenario Outline: 05_Check Order At Price
        ...
        Examples:
            ...
            | Москва-Воронеж | Даймекс | 20т-33п-Реф | 20т-66п-Тент | VC3000             | VC3002             | 733905098321 | 67000             |


    Scenario: 05_Check Order At Price ч2
