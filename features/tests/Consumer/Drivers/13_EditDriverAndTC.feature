...
Feature: Edit Driver And TC
    ...
    Scenario Outline: 13_Edit Driver And TC
       ...
       # проверить что водитель сохранен
        ...
        Examples:
            ...
            | Ахмедов Гамза Ибрагимович | водитель изменен на Аликин Алексей Юрьевич | Ителла | А018МЕ 199 | ТС изменено на А018МЕ 199 | CONSMSKFM          | Пенза              | 1603706S   | 105000            | Consumer Transport Coordinator |
