...
Feature: Check driver
    ...
    Scenario Outline: 09_Check create driver
        ...
        Examples:
            ...
            | 102030405      | Essers EU | 5845701020      | ОВД Москва | CONSMSKFM          | Пенза              | 1603706S   | 105000            | 45127845       | 10/10/2020   | 45127846    | самый лучший водитель |
