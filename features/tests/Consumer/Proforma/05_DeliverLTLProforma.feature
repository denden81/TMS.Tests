...
Feature: Check Deliver LTL Proforma
    ...
    Scenario Outline: 05_Deliver LTL Proforma
        ...
        Examples:
            ...
            | Ителла | CONSMSKFM          | Российская Федерация 440516 Пензенский р-н с. Саловка Полевая ул. д.15 | 1603706S   | 105000            | Consumer Transport Coordinator | паллетная доставка (тент) |
