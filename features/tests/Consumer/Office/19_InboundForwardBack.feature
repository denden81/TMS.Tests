...
Feature: Check inbound waybills
    ...
    I want to check inbound waybills goes forward and back
        ...
        #создаем накладную
    Scenario Outline:19_Inbound Forward And Back:Самоввоз вперед и назад
        ...
        Examples:
            ...
            | Ителла | DePuy              | Российская федерация, Московская область, г. Долгопрудный, микрорайон Павельцево, новое шоссе, д. 34, стр. 4 | 200165000  | 50000             | MD Transport Coordinator |
