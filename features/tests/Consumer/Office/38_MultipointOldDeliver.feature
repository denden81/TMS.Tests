...
Feature: Check Multipoint Old Deliver in grid
    ...
    Scenario Outline: 38_Multipoint Old Deliver:Проверить прогон старой мультиточечной перевозки по статусам вперед и назад
        Given I log in as a "<login coordinator>" on homepage
        And I expect this element "Loader" is not visible
        And I wait on elements "Office"
        When I click on this element "RemoveFilter"
        And I expect this element "Loader" is not visible
        # установка 2017 года и нахождения накладной 0081006821
        And I expect this element "Loader" is not visible
        And I set date years "2018"
        And I expect this element "Loader" is not visible
        Then I click in standart element "0081006821"
        And I expect this element "Loader" is not visible
