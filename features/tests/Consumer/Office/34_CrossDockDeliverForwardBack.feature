...
Feature: Check Cross Dock waybills
    ...
    I want to check Cross Dock waybills goes forward and back
        ...
        # создаем накладную
    Scenario Outline: 34_Cross Dock waybills goes forward and back
        ...
        Examples:
            | TK     | shipping warehouse | delivery warehouse                        | delivery warehouse 2              | vendorcode | number vendorcode | login coordinator              |Direction       |
            | Ителла | CONSMSKFM          | 400050, Волгоград, ул. Хиросимы, 16 Б     | г. Волгоград. ул Армавирская 11-24| 1603706S   | 105000            | Consumer Transport Coordinator |Москва~Волгоград|
