...
Feature: Check alternative filter
    ...
    Scenario Outline: 02_Check alternative filter:Проверка альтернативного фильтра склада доставки
        ...
        And I expect this element "Loader" is not visible
        And I expects that element "tmsGridCellLeft" contains the text "<customer text>"
