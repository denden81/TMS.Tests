...
Feature: Check delete waybills
    ...
    I want to check delete waybills in shipping
        ...
        #создаем накладную
    Scenario Outline:21_Delete Waybills in Shipping
        ...
        Examples:
            ...
            | CONSMSKFM          | Российская Федерация 440516 Пензенский р-н с. Саловка Полевая ул. д.15 | 1603706S   | 110000            | Consumer Transport Coordinator |
