...
Feature: Add user
    ...
    Scenario: 01_Create User Broker: Проверка создания нового юзера и авторизации под ним ч1
        ...
        And I click on this element "inputRoleBroker"
        And I click on this element "buttonSave"
       And I open the url "/logout"

    Scenario: 01_Create User: Проверка создания нового юзера и авторизации под ним ч2
...
# кнопка профайл не нажимается из за обновления страницы
  ...
  #  Scenario: 01_Create User: Проверка создания нового юзера и авторизации под ним ч3
