...
Feature: Check waybills
    As a admin
    I want to make waybills and shipping and change total summ invoice two waybills draft MO

        # создаем накладную
    Scenario Outline: 15_Change Total Summ Invoice Two Waybills Draft MO
