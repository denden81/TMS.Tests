...
Feature: Check waybills
    ...
    I want to make waybills and shipping and change total summ invoice two waybills draft
        ...
        # создаем накладную
    Scenario Outline: 14_Change Total Summ Invoice Two Waybills
       ...
       # And I expect this element "Loader" is not visible
        ...
        And thes element "Грид перевозки весь" contains the text "Total сумма по инвойсам установлена в 109000.00"

        Examples:
            | login coordinator2             | shipping warehouse | delivery warehouse | vendorcode            | number vendorcode | login coordinator        |
            | Consumer Transport Coordinator | Ethicon LLC Brazil        | MD Лесной          | TRILOC II CUP 32/44mm | 47500             | MD Transport Coordinator |
