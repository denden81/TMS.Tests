...
Feature: Check pickup waybills
    ...
    I want to check pickup waybills goes forward and back
        ...
        #создаем накладную
    Scenario Outline: 23_Pickup Forward And Back: Самовывоз вперед назад
       ...
       # откат с ТС прибыло на погрузку  до Подтверждена в перевозке
        ...
        Examples:
            ...
            | Ителла | MD Долгопрудный    | Российская Федерация 440516 Пензенский р-н с. Саловка Полевая ул. д.15 | TRILOC II CUP 32/44mm | 47500             | MD Transport Coordinator |
