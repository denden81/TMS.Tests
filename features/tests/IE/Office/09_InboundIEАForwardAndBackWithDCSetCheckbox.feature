...
Feature: Check inbound waybills
    ...
    I want to check waybills goes forward and back
        ...
        # создаем накладную
    Scenario Outline: 09_Inbound IE Forward And Back With DC and Without Checkbox Go Forward
       ...
       # And I expect this element "Loader" is not visible
        ...
        And I click on this element "Выпуск ДС в перевозке"
        And I expect this element "Loader" is not visible
        ...
        And thes element "Грид перевозки статус ТС прибыло на таможню" contains the text "ТС прибыло на таможню"
         ...
         # перевести статус перевозки "ДТ получена"
        And I scroll to elements "Кабинет в хедере"
        And I click on this element "ДС получено в перевозке"
        And I accept the alertbox
        And thes element "Грид перевозки статус ДC получено" contains the text "ДС получено"
