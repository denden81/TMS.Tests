...
Feature: Check waybills
    As a admin
    I want to make waybills and shipping and change total summ invoice two waybills

        # создаем накладную
    Scenario Outline: 13_Change Total Summ Invoice Two Waybills
        ...
        And I scroll to elements "Выбор ТК"
        ...
        And thes element "Грид перевозки весь" contains the text "Total сумма по инвойсам установлена в 54500.00"
