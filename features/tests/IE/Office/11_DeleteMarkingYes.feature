...
Feature: Check waybills
    ...
    I want to check make waybills and delete marking
        ...
        #создаем накладную
    Scenario Outline: 11_Delete Marking Yes
       ...
       # Добавление рандомного номера заказа накладной
        ...
        Then I click on this element "Да в окне удаления позиции в накладной"
        And I expect this element "Loader" is not visible
        ...
        # проверяем заполнение артикулов в перевозке
        ...
        # перекодим в кабинет и заходим в копию
        And I open the url "/"
        And I expect this element "Loader" is not visible
        And I click on this element "predstavlenie1"
        And I wait on elements "Office"
        ...
        And I expect this element "Loader" is not visible
        Then I click in random element "random number copy IE"
        And thes element "Грид накладной статус Создана" contains the text "Создана"

        # проверяем артикул,массу
        And I scroll to elements "Линк история накладной"
        When I click on this element "Позиции в накладной"
        And thes element "Масса накладной плановая брутто" contains the text "<vendorcode2massgross>"
        And thes element "Грид накладной" contains the text "<vendorcode2>"
        # проверяем запись в истории
        And I scroll to elements "Линк история накладной"
        And I click on this element "Линк история накладной"
        And thes element "Грид накладной" contains the text "Накладная создана путем переноса позиций из накладной"
