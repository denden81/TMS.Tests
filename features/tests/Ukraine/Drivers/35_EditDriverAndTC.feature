...
Feature: Edit Driver And TC
    ...
    Scenario Outline: 35_Edit Driver And TC
       ...
       # проверить что водитель сохранен
        ...
        Examples:
            | driver name               | driver history                                | TC                        | TC history                               | TK      | shipping warehouse                                              | delivery warehouse                 | vendorcode | number vendorcode | login coordinator         |
            | Бондарчук Сергій Іванович | водитель изменен на Бондарчук Сергій Іванович | Scania AI6560ET / AI0361XK | ТС изменено на Рено / АХ 0272ЕВ АХ1022ХР | ТОВ ХФК | вул. Садова 26-а, смт. Гостомель, Київська обл., 08290, Україна | 08300 Бориспіль вул. Запорізька 28 | 8077501    | 225000            | Ukr Transport Coordinator |
