...
Feature: Check search driver
    ...
    Scenario Outline: 33_Check Create Driver
        ...
        And I click "<TK>" on the element "Поиск Транспортной компании водителя Украины"
        And I expect this element "Loader" is not visible
        ...
        Examples:
            ...
            | 102030405      | ТОВ ХФК | 5845701020      | ОВД Москва | 45127845       | 10/10/2020   | 45127846    | самый лучший водитель |
