...
Feature: Check driver
    ...
    Scenario Outline: 31_Check Create Driver
        ...
        #When I click on this element "Кабинет"
        And I open the url "/"
        And I expect this element "Loader" is not visible
        And I expect this element "Loader" is not visible
       ...
       # Добавление склада отгрузки и доставки
        ...
        Examples:
            ...
            | 102030405      | ТОВ ХФК | 5845701020      | ОВД Москва | вул. Садова 26-а, смт. Гостомель, Київська обл., 08290, Україна | 08300 Бориспіль вул. Запорізька 28 | 8077501    | 110000            | 225000         | 10/10/2020   | 45127846    | самый лучший водитель |
