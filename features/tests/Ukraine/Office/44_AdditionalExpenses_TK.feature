...
Feature: additional expensive TK
    ...
    Scenario Outline: 44_Additional Expensive TK
       ...
       #заходим транспортной компанией и заполняем доп затраты
        ...
        Examples:
            ...
            | ТОВ ХФК | вул. Садова 26-а, смт. Гостомель, Київська обл., 08290, Україна | 08300 Бориспіль вул. Запорізька 28 | 8077501    | 225000            | Ukr Transport Coordinator | Ukr Transport Company |
