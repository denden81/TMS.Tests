...
Feature: Check old waybills
    ...
    I want to check old waybills goes forward and back
       ...
       # находим накладную
    Scenario Outline: 10_Deliver Old Waybills Forward And Back
        Given I log in as a "<login coordinator>" on homepage
        And I expect this element "Loader" is not visible
        And I wait on elements "Office"
        When I click on this element "RemoveFilter"
        And I expect this element "Loader" is not visible
        #установка 2016 года и нахождения накладной IM-4001549026
        And I expect this element "Loader" is not visible
        And I set date years "2016"
        And I expect this element "Loader" is not visible
        Then I click in standart element "IM-4001549026"
        And I expect this element "Loader" is not visible
