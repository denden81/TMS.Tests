...
Feature: Check add waybills in MO
    As a admin
    I want to check add waybills MO

        # создаем 1ю накладную
    Scenario Outline: 16_Check Add Waybills Shipping In MO
       ...
       # читаем номер у 2ой перевозки и заполняем его в поле в МО
        And I read number carriages "ukraine" and add him in MO
        ...
        And thes element "Грид перевозки весь" contains the text "через массовые операции"
