...
Feature: Check waybills Deliver Forward CS
    ...
    I want to check waybills goes forward
        ...
        #создаем накладную
    Scenario Outline: 42_Waybills Deliver Forward CS
       ...
       # перевести статус "В перевозке"
        ...
        Examples:
            ...
            | ТОВ ХФК | вул. Садова 26-а, смт. Гостомель, Київська обл., 08290, Україна | 08300 Бориспіль вул. Запорізька 28 | 8077501    | 225000            | Ukr Customer Service |
