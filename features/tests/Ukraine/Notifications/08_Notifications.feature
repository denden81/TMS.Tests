...
Feature: Check Notifications
    ...
    Scenario Outline: 08_Check Notifications: ч1
        ...
        And I add "testmail11" to the inputfields "inputEmail"
        ...
        And I click on this element "Редактирование пользователя"
        And I add "testmail12" to the inputfields "inputEmail"
        And I click on this element "buttonSave"
        And I expect this element "Loader" is not visible
        ...
        And I click on this element "Редактирование пользователя"
        And I add "testmail13" to the inputfields "inputEmail"
        And I click on this element "buttonSave"
        And I expect this element "Loader" is not visible
        ...
        And I click on this element "Редактирование пользователя"
        And I add "testmail14" to the inputfields "inputEmail"
        And I click on this element "buttonSave"
        And I expect this element "Loader" is not visible
        ...
        And I click on this element "Редактирование пользователя"
        And I add "testmail15" to the inputfields "inputEmail"
        And I click on this element "buttonSave"
        And I expect this element "Loader" is not visible
       ...
       And I open the url "/logout"
        ...
        Examples:
            | coordinator | customer          | transport_tk          | sklad          | sklad2          | comment sklad  | comment sklad2 |
            | test_ukr2   | test_ukr_customer | test_ukr_transport_tk | test_ukr_sklad | test_ukr_sklad2 | Склад отгрузки | Склад доставки |

        #заходим юзером с ролью кастомер сервис и создаем накладную
    Scenario Outline: 08_Check Notifications: ч2
        # create waybills
       ...
       # перевести статус "В перевозке"
        ...
        And I add "Б" to the inputfields "В поле поиска водителя"
        ...
        And I expects that element "Грид перевозки" contains the text "Б"
        ...
        Examples:
            ...
            | ТОВ ХФК | JJBC01             | 08300 Бориспіль вул. Запорізька 28 | 8077501    | 225000            | Ukr Transport Coordinator | Ukr Customer Service | Ukr Sklad   | Ukr Sklad2   |

    Scenario: 08_Check Notifications: ч3
        # Check mail
        And I open the sites "Майлнезия"
        # проверяем письма у транспортного координатора
        And I add "testmail11" to the inputfields "В поле поиска email"
        When I click on this element "Стрелка входа"
        And I have closed all but the first tab
        And I wait on mailnesia elements "testmail11"
        ...
        And I add "testmail12" to the inputfields "В поле поиска email"
        When I click on this element "Стрелка входа"
        And I have closed all but the first tab
        And I wait on mailnesia elements "testmail12"
        And I expects that element "Грид Mailnesia" contains the text "Перевозка подтверждена (Artlogics_INFO_#2)"
        And I expects that element "Грид Mailnesia" contains the text "Artlogics_INFO_#5"
        Then I delete all mails in mailnesia

        # проверяем письма у транспортной компании
        And I add "testmail13" to the inputfields "В поле поиска email"
        Then I click on this element "Стрелка входа"
        And I have closed all but the first tab
        And I wait on mailnesia elements "testmail13"
        And I expects that element "Грид Mailnesia" contains the text "Artlogics_INFO_#6"
        Then I delete all mails in mailnesia

        # проверяем письма у склада отгрузки
        And I add "testmail14" to the inputfields "В поле поиска email"
        Then I click on this element "Стрелка входа"
        And I have closed all but the first tab
        And I wait on mailnesia elements "testmail14"
        And I expects that element "Грид Mailnesia" contains the text "Накладная готова к подборке (Artlogics_INFO_#1)"
        And I expects that element "Грид Mailnesia" contains the text "Перевозка подтверждена (Artlogics_INFO_#2)"
        And I expects that element "Грид Mailnesia" contains the text "Artlogics_INFO_#5"
        Then I delete all mails in mailnesia
        ...
        And I add "testmail15" to the inputfields "В поле поиска email"
        When I click on this element "Стрелка входа"
        And I have closed all but the first tab
        And I wait on mailnesia elements "testmail15"
